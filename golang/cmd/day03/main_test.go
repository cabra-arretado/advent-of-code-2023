...
func TestFindFullNumber(t *testing.T) {
	...
	expected2Index := "1-1"
	expected2Num := 456
	actual2Index, actual2Num, _ := findFullNumber(matrix, 1, 1)
	...
	expected3Index := "2-0"
	expected3Num := 5
	actual3Index, actual3Num, _ := findFullNumber(matrix, 2, 0)
	...
	expected4Index := "2-4"
	expected4Num := 4
	actual4Index, actual4Num, _ := findFullNumber(matrix, 2, 4)
	if actual3Index != expected3Index || actual3Num != expected3Num {
